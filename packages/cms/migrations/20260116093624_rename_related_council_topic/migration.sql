/*
  ...
  - You are about to drop the `_CouncilTopic_relatedLegislativeTopics` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `_CouncilTopic_relatedLegislativeTopics` DROP FOREIGN KEY `_CouncilTopic_relatedLegislativeTopics_A_fkey`;

-- DropForeignKey
ALTER TABLE `_CouncilTopic_relatedLegislativeTopics` DROP FOREIGN KEY `_CouncilTopic_relatedLegislativeTopics_B_fkey`;

-- DropTable
DROP TABLE `_CouncilTopic_relatedLegislativeTopics`;
